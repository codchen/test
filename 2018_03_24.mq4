...
void SetEnterSignal()
   {
     if (ac_signal == 1 && rsi_signal > 0) {
       enter_signal = 0.1 * rsi_signal;
     } else if (ac_signal == -1 && rsi_signal < 0) {
       enter_signal = 0.1 * rsi_signal;
     } else {
       enter_signal = 0.0;
     }
...
void SetExitSignal()
   {
     if (rsi_signal > 0 && ac_signal < 0) {
       exit_signal = 1;
     } else if (rsi_signal < 0 && ac_signal > 0) {
       exit_signal = -1;
     } else {
       exit_signal = 0;
     }
